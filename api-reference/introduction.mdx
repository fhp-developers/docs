...
<CardGroup cols={2}>
  ...
  <Card title="Product codes" icon="barcode" href="/concepts/product-codes">
    Catalog products expose `productCode` and per-locale `sku` — Kalixo identifiers, not provider barcodes.
  </Card>
...
<Tip>
  ...
  [Postman collection](/kalixo-api-v2.postman_collection.json) with
