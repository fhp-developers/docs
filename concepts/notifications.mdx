...
<Info>
  Email alerts are the first notification type. HTTP webhooks for events such as
  `order.completed` and `balance.low` are planned - this page will be updated when they ship.
</Info>
